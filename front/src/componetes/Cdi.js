            ...
            <div className="container-investimentos">
                ...
                <div className="caixa-investimentos">
                    <div className="caixa-cdi">
                        <input type="radio" name="BancoCdi" value="Nubank" onChange={(e) => setBancoSelecionado(e.target.value)} />
                        <p>Nubank</p>
                    </div>

                    <div className="caixa-cdi">
                        <input type="radio" name="BancoCdi" value="PicPay" onChange={(e) => setBancoSelecionado(e.target.value)} />
                        <p>PicPay</p>
                    </div>

                    <div className="caixa-cdi">
                        <input type="radio" name="BancoCdi" value="Inter" onChange={(e) => setBancoSelecionado(e.target.value)} />
                        <p>Inter</p>
                    </div>
                    <div className="caixa-cdi">
                        <input type="radio" name="BancoCdi" value="Bradesco" onChange={(e) => setBancoSelecionado(e.target.value)} />
                        <p>Bradesco</p>
                    </div>
                    ...
                    <div className="resultado-cdi">
                        ...
                        <input type="number" name="meses" value={meses} onChange={(e) => setMeses(e.target.value)} />
                        <button className="calcular" onClick={calcularCDI}> calcular </button>
                    </div>
                    {erro && <h1 className="res">{erro}</h1>}
                    {!erro && resultado && <h1 className="res">Resultado: {resultado}</h1>}
                </div>
            </div>
        </div>
    )
